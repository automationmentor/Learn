...
@CucumberOptions(
		features = "src/test/resources/features/Dweb/Login.feature"
		,glue={"stepDefinition.Dweb"}
		,plugin = {"com.sitture.ExtentFormatter:src/test/resources/reports/Dweb/GUIreport.html"},monochrome =true
		)

// you need to extend the runner class with AbstractTestNGCucumberTests if you want to run with TestNG or testng.xml
public class TestRunnerDweb extends AbstractTestNGCucumberTests{
	@AfterClass
